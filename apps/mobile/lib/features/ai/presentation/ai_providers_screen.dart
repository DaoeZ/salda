              ...
              child: ListTile(
                ...
                trailing: _configured[provider.id] == true
                    ? IconButton(
                        ...
                        icon: Icon(_preferred == provider.id
                            ? Icons.star
                            : Icons.star_border),
                        onPressed: () async {
                          await ref
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (sheetContext) => Padding(
        ...
        child: StatefulBuilder(builder: (sheetContext, setSheetState) {
          ...
          var testing = false;
          String? testError;
          return StatefulBuilder(builder: (sheetContext, setInner) {
            Future<void> test() async {
              ...
              try {
                await provider.testConnection(AiProviderConfig(
                  apiKey: key.text.trim(),
                  baseUrl:
                      baseUrl.text.trim().isEmpty ? null : baseUrl.text.trim(),
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        helperText:
                            provider.requiresApiKey ? null : l10n.aiKeyOptional),
                  ),
                    ...
                    FilledButton(
                      ...
                      onPressed: !tested
                          ...
                          : () async {
                              ...
                              if (await store.preferredProviderId() == null) {
